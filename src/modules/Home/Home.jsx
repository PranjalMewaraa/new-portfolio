            ...
            >
              ...
              <div id="about" className="w-full flex gap-8 justify-end">
                ...
                <div className="w-full md:w-1/3 text-white font-[gil] text-justify text-xl md:text-[1.1vw]">
                  ...
                  applications and not only limiting to that i love to code
                  those too. I am a CSE undergrad from Chandigarh University and
                  Lead UI Designer and F.E. from Crud Studio. My love life
                  includes Javascript Frameworks and libraries like React,
                  React-Native, Next, Node, Express with pinch of SQL and NOSQL
                  DBs.
                </div>
              </div>
          ...
          >
            ...
            >
              ...
              >
                <div
                  id="end"
                  className="sm:w-2/3 md:w-1/2 h-full flex items-end"
                >
